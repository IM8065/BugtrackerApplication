...
namespace Bugtracker.Migrations
{
    ...
    [Migration("20201026230648_Something happened")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bugtracker.Models.Severity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bugtracker.Models.TicketModel", b =>
                {
                    ...
                    b.HasOne("Bugtracker.Models.Severity", "Severity")
                        .WithMany()
                        .HasForeignKey("SeverityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Bugtracker.Models.Status", "TicketStatus")
                        .WithMany()
